                        ...
                        <div class="forms-sample mb-5">
                            <div class="form-group row g-3">
                                <div class="col-md-3">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlCategory" Enabled="false" CssClass="form-select">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <asp:TextBox runat="server" ID="txtClientSubbrokerCode" CssClass="form-control" placeholder="Enter Client/Subbroker Code">                                          
                                    </asp:TextBox>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:TextBox runat="server" ID="txtAdd1" CssClass="form-control" placeholder="Enter Address 1">                                      
                                    </asp:TextBox>
                                </div>

                                <div class="col-md-3">
                                    <label>Address 2</label>
                                    <asp:TextBox runat="server" ID="txtAdd2" CssClass="form-control" placeholder="Enter Address 2">                                      
                                    </asp:TextBox>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <label>PAN</label>
                                    <asp:TextBox runat="server" ID="txtPAN" oninput="toUpperCase(this);" MaxLength="10" CssClass="form-control" placeholder="Enter PAN">                                      
                                    </asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <label>Mobile</label>
                                    <asp:TextBox runat="server" ID="txtMobile" MaxLength="10" CssClass="form-control" placeholder="Enter Mobile">                          
                                    </asp:TextBox>
                                    <asp:RegularExpressionValidator
                                        ID="revPhone"
                                        runat="server"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlSort" CssClass="form-select">
                                        <asp:ListItem Text="Select Sorting" Value=""></asp:ListItem>
