    ...
    public partial class SearchInvestorMerge : System.Web.UI.Page
    {
        ...
        protected void btnFind_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                objIM.PHONE = txtPhone.Text.Trim().ToUpper(); ;
                ...
                // sam
                string clientSubbroker = ddlCategory.SelectedItem.Text.Trim().ToUpper();

                ResponseResult = new WM.Controllers.InvestorMergeController().GetSearchForMerge(clientSubbroker, objIM);
                if (ResponseResult.Rows.Count > 0)
                {
                    
                    lblMessage.Text = $"Total record(s): {ResponseResult.Rows.Count.ToString()}";
