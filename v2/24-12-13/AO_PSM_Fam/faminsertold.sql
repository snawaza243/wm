create or replace PROCEDURE psm_ao_insert_member2 (
...
SELECT MAX(inv_code) INTO nextinvkyc
...
OPEN p_result FOR
SELECT
    'Successfully member added: client code --> ' || v_generated_client_code || ' | Inv Code --> ' || nextinvkyc AS message
FROM dual;

COMMIT;

END psm_ao_insert_member2;