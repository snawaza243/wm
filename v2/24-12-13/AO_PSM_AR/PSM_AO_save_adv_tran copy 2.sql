...
BEGIN
    ...
    INSERT INTO transaction_sttemp (
        ...
        p_branch, p_source_id, p_rm_code, TRIM(p_busi_code), p_branch, TRIM(p_cheque_no), p_chq_date,
    ...
    INSERT INTO transaction_st (
        ...
        NULL, v_adv_fr_ren, p_amount, p_branch, p_source_id, p_rm_code, TRIM(p_busi_code), p_branch,
