...
namespace WM.Controllers
{
    public class NpsTransactionPunchingController
    {
        ...
        public DataTable ProcessFinalNpsEcsBulkImport(string importType, string zeroCommission, string logId, string roleId, string company, string status, out string returnMessage)
        {
