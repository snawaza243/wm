    ...
    IF LENGTH(TRIM(P_EXIST_CLIENT_CODE)) >= 11 THEN
        ...
        IF DCT_FLAG > 0 THEN
            ...
            SET
                ...
                EMAIL                   = P_EMAIL_VALUE ,
                STD1                    = P_PHONE_OFFICE_STD_VALUE,
                TEL1                    = P_PHONE_OFFICE_NUMBER_VALUE,
                STD2                    = P_PHONE_RES_STD_VALUE,
            ...
            SET
                ...
                CM.STD1                 = P_PHONE_OFFICE_STD_VALUE,  
                CM.STD2                 = P_PHONE_RES_STD_VALUE,  
            ...
            UPDATE  TB_DOC_UPLOAD SET     INV_CODE        = (SELECT MAX(CLIENT_CODEKYC) FROM CLIENT_TEST WHERE CLIENT_CODE = P_SEARCH_CLIENT_CODE)                  
            WHERE   COMMON_ID       = P_DT_NUMBER AND INV_CODE IS NULL;            
