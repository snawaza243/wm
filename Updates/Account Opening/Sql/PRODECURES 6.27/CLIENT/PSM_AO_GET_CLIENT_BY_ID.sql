        ...
        IF ISINCT >0 THEN
            OPEN P_RESULT FOR
               SELECT
                    ...
                    EM.RM_NAME                         AS RM_NAME,          -- RM_NAME
                    NVL(BM.BRANCH_NAME,'')             AS BRANCH_CODE ,     -- BRANCH_NAME
                    NVL(CM.GUEST_CD, '')               AS GUEST_CODE,       -- GUEST_CODE
                    NVL(CT.STATUS, '')                 AS STATUS, -         -- TAXT STATUS      FROM CT
                    IM.OCCUPATION_ID                   AS OCC_ID,           -- OCCUPATION       FROM IM
                    IM.OCCUPATION_ID                   AS IM_OCC_ID,        -- OCC              FROM IM    
                    ...
                    */          
                    ...
                    CIM_MAIL.CITY_ID                   AS MAILING_CITY,         -- MALING CITY
                    STM_MAIL.STATE_ID                  AS MAILING_STATE,        -- MALING STATE
                    CTM_MAIL.COUNTRY_ID                AS MAILING_COUNTRY,      -- MAILING COUNTRY
                    CIM_PERM.CITY_ID                   AS PERMANENT_CITY,       -- PER CITY
                    STM_PERM.STATE_ID                  AS PERMANENT_STATE,      -- PER STATE
                    CTM_PERM.COUNTRY_ID                AS PERMANENT_COUNTRY     -- PER COUNTRY
            ...
            OPEN P_RESULT FOR
               SELECT
                    ...
                    */
                    ...
                    CM.REF_MOB3                        AS REF_MOB3,
                    CM.REF_MOB4                        AS REF_MOB4, 
                    CIM_MAIL.CITY_ID                   AS MAILING_CITY,         -- MAILING CITY
                    STM_MAIL.STATE_ID                  AS MAILING_STATE,        -- MAILING STATE
                    CTM_MAIL.COUNTRY_ID                AS MAILING_COUNTRY,      -- MAILING COUNTRY
                    CIM_PERM.CITY_ID                   AS PERMANENT_CITY,       -- PER CITY
                    STM_PERM.STATE_ID                  AS PERMANENT_STATE,      -- PER STATE
                    CTM_PERM.COUNTRY_ID                AS PERMANENT_COUNTRY     -- PER COUNTRY
