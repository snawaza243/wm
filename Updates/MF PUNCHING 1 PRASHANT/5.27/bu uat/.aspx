                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group" style="text-align: center;">
                                    ...
                                    <asp:Panel ID="popupDuplicate" runat="server" CssClass="panel panel-default draggable"
                                        Style="display: none; width: 1500px; height: auto; top: 50%; left: 50%; transform: translate(-50%, -50%); background: #d3d3d3; border: 2px solid black; padding: 10px; box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.5); z-index: 1000; border-radius: 5px; position: fixed;">
