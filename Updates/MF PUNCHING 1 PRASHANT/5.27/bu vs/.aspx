...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    const frequencyInput = document.getElementById("<%= ddlFrequency.ClientID %>");
                                        ...
                                        <div class="col-md-8">
                                            <div class="d-flex align-items-md-center flex-wrap gap-3">
                                                ...
                                                <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary" Text="Add" OnClick="btnAddClick" OnClientClick="return validateFolioOnAdd();" />
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div id="tranDetails" runat="server">
                                        <h4 class="card-title">Tran Details
                                        </h4>
                                        ...
                                        <div class="row g-3 mb-3">
                                            ...
                                            <div class="col-md-3">
                                                <label for="accountHolder" class="form-label">Account Holder</label>
                                                <asp:TextBox ID="accountHolderV" runat="server" CssClass="form-control" Placeholder="Account Holder"></asp:TextBox>
                                            </div>
                                            ...
                                            <asp:Panel ID="SchemeSearchPanel2" runat="server" CssClass="panel panel-default draggable"
                                                Style="display: none; position: fixed; top: 20%; left: 35%; width: 30%; max-height: 400px; overflow: auto; background-color: white; border: 1px solid #ccc; z-index: 1000;">
                                            ...
                                            <asp:Panel ID="Panel3" runat="server" CssClass="panel panel-default draggable"
                                                Style="display: none; position: fixed; top: 20%; left: 35%; width: 30%; max-height: 400px; overflow: auto; background-color: white; border: 1px solid #ccc; z-index: 1000; padding: 15px;">
                                                <div class="panel-heading" style="cursor: move; display: flex; justify-content: space-between; align-items: center;">
                                                    <h4 class="panel-title">Investor Address Updation (Panel 3)</h4>
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-md-center flex-wrap flex-md-row flex-column gap-3">
                                                    ...
                                                    <script type="text/javascript">
                                                        function validateFolioOnModify() {
                                                            const transactionType = document.getElementById('<%= DropDownList4.ClientID %>').value;
                                                            const sipStpType = document.getElementById('<%= sipStp.ClientID %>').value;
                                                            const folio1 = document.getElementById('<%= TextBox13.ClientID %>').value.trim();
                                                            const folio2 = document.getElementById('<%= TextBox2.ClientID %>').value.trim();
                                                            const folio3 = document.getElementById('<%= TextBox12.ClientID %>').value.trim();
                                                        ...
                                                        function validateFolioOnAdd() {
                                                            ...
                                                            const folio2 = document.getElementById('<%= txtChequeNo.ClientID %>').value.trim();
                                                            ...
                                                            if (transactionType === "SWITCH IN" && sipStpType === "REGULAR") {
                                                                if (!folio1 || !folio3) {
                                                                    alert("Folio 1 and Folio 3 are required for SWITCH case.");
                                                                    return false;
                                                                }
                                                                if (folio1 !== folio2) {
                                                                    alert("Folio 1 and Folio 3 must be the same for SWITCH.");
                                                                    return false;
                                                                }
                                                            }
    ...
    <%--<script>
        function showChequeDetailsOnly() {
            ...
            document.getElementById("hdnSelectedPaymentMethod").value = "cheque";
        }
    ...
    <%--<script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            // Ensure correct state of fields on page load
            initializeFieldsAfterPostback();

            // Attach event listener to transaction type dropdown
            document.getElementById('<%= transactionType.ClientID %>').addEventListener('change', function () {
                toggleSwitchSTPFields(this.value);
                saveSwitchFields(); // Save values on change
            });
            ...
            paymentMethods.forEach(id => {
                ...
                if (radioBtn) {
                    radioBtn.addEventListener('change', function () {
                        ...
                        savePaymentSelection();  // Save selection when user changes it
                    });
                }
            });

            // Restore field values after postback
            restoreSwitchFields();
    ...
    '<%= txtOthersDate.ClientID %>'
            ...
            fieldsToDisable.forEach(id => {
                ...
                if (field) {
                    ...
                    if (isSwitchIn) {
                        field.value = ''; // Clear input values when disabled
                    }
                }
            });
    ...
    '<%= neft.ClientID %>'
            ...
            // Toggle ReadOnly and Disabled attributes for formSwitch fields
            ...
            // Only clear values if explicitly changed to "SWITCH IN"
            if (isSwitchIn) {
                sessionStorage.setItem("formSwitchFolio", formSwitchFolio.value); // Store values before clearing
            ...
            const elements = [formSwitchFolio, formSwitchScheme];
            elements.forEach(el => {
                if (!isSwitchIn) {
                    el.style.filter = "blur(1px)";  // Add blur effect
        ...
        // Function to save switch folio and scheme values before postback
        ...
        // Function to restore switch folio and scheme values after postback
        ...
        // Function to save selected payment method before postback
    ...
    '<%= rtgs.ClientID %>',
        ...
        // Function to restore the selected payment method after postback
    ...
    <%--<script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Check if the hidden field has a value set after postback
            const selectedValue = hdnSipStpValue.value || ddlSipStp.value;
            toggleFields(selectedValue); // Set fields based on value after postback

            // Add event listener to dropdown
            ddlSipStp.addEventListener('change', function () {
                const selectedValue = ddlSipStp.value;
                hdnSipStpValue.value = selectedValue;  // Store selected value in hidden field
            ...
            function toggleFields(selectedValue) {
                ...
                if (transactionTypeValue === 'SWITCH IN') {
                    ...
                    installmentTypeContainer.style.display = 'block';
                    disableSwitchFields(); // Disable Switch fields
                    ...
                    enableSwitchFields(); // Enable Switch fields when "STP" is selected
                }
            ...
            // Function to enable switch folio and scheme fields
            function enableSwitchFields() {
                formSwitchFolio.readOnly = false;
                formSwitchScheme.readOnly = false;
                btnSearchFormSwitchScheme.disabled = false;
            ...
            // Function to disable switch folio and scheme fields
            function disableSwitchFields() {
                formSwitchFolio.readOnly = true;
                formSwitchScheme.readOnly = true;
                btnSearchFormSwitchScheme.disabled = true;

                formSwitchFolio.style.filter = "blur(3px)";
                formSwitchFolio.style.pointerEvents = "none";

                formSwitchScheme.style.filter = "blur(3px)";
                formSwitchScheme.style.pointerEvents = "none";
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Attach event listener to transaction type dropdown
            document.getElementById('<%= transactionType.ClientID %>').addEventListener('change', function () {
                checkTransactionType(this.value);

            });
            document.getElementById('<%= ddlSipStp.ClientID %>').addEventListener('change', function () {
                checkTransactionType(this.value);
        ...
        // Function to check transaction type and clear Switch Folio & Scheme if "PURCHASE"
        function checkTransactionType(transactionValue, sipTypeValue) {
            const isPurchase = transactionValue === "PURCHASE";
            const ddlsipstp = sipTypeValue === "STP";
            const formSwitchFolio = document.getElementById('<%= formSwitchFolio.ClientID %>');
            const formSwitchScheme = document.getElementById('<%= formSwitchScheme.ClientID %>');

            if (isPurchase && !ddlsipstp) {
                formSwitchFolio.value = ''; // Clear Switch Folio
                formSwitchScheme.value = ''; // Clear Switch Scheme
            }
        }

        // Function to check transaction type on page load
