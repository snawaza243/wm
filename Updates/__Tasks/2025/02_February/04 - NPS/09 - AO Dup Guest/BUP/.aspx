...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <span class="input-group-text"><i class="glyphicon glyphicon-th"></i></span>
                                          ...
                                          <%--  <script>
                                                $(document).ready(function () {
                                                    ...
                                                    // Ensure popup dynamically adjusts position
    ...
    <div class="col-md-2">
        ...
        <asp:TextBox ID="InvestorListPan" runat="server" CssClass="form-control" 
            ...
            ToolTip="Enter PAN Number (e.g. AAAAA9999A)" aria-label="PAN" />
    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-3">
                                                ...
                                                <script>
                                                    function onLoadAOPaymentSetup() {
                                                        // Get the radio buttons and relevant fields
                                                        const chequeRadio = document.getElementById('<%= cheque.ClientID %>');
                                                        const draftRadio = document.getElementById('<%= draft.ClientID %>');
                                                        const cashRadio = document.getElementById('<%= optCash.ClientID %>');

                                                        const chequeLabel = document.getElementById('<%= ChequeLabel.ClientID %>');
                                                        const chequeDateLabel = document.getElementById('<%= ChequeDatedLabel.ClientID %>');
                                                        const chequeDateInput = document.getElementById('<%= txtChequeDate.ClientID %>');
                                                        const chequeNoInput = document.getElementById('<%= txtChequeNo.ClientID %>');

                                                        // Function to update labels and fields based on selected payment type
                                                        function updatePaymentType() {
                                                            if (chequeRadio.checked) {
                                                                chequeLabel.innerHTML = "Cheque No <span class='text-danger'>*</span>";
                                                                chequeDateLabel.innerHTML = "Cheque Dated <span class='text-danger'>*</span>";
                                                                chequeDateInput.disabled = false;
                                                                chequeNoInput.disabled = false;
                                                            } else if (draftRadio.checked) {
                                                                chequeLabel.innerHTML = "Draft No <span class='text-danger'>*</span>";
                                                                chequeDateLabel.innerHTML = "Draft Dated <span class='text-danger'>*</span>";
                                                                chequeDateInput.disabled = false;
                                                                chequeNoInput.disabled = false;
                                                            } else if (cashRadio.checked) {
                                                                chequeLabel.innerHTML = "";
                                                                chequeDateLabel.innerHTML = "";
                                                        ...
                                                        chequeRadio.addEventListener("change", updatePaymentType);
                                                        draftRadio.addEventListener("change", updatePaymentType);
                                                        cashRadio.addEventListener("change", updatePaymentType);
                                                    ...
                                                    //window.onload = onLoadAOPaymentSetup;
