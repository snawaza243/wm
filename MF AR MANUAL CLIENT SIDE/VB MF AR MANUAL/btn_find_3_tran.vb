...
VSFlexGrid1_reset
findsql = ""
findsql = "select nvl(HO_TRAN_CODE,0)HO_TRAN_CODE,branch_name,amount from TRANSACTION_ST@mf.bajajcapital a,branch_master b where a.branch_code=b.branch_code and TRAN_CODE='" & txtfindtran.Text & "'"
...
While Not rsfindtr.EOF   'Or rsfindtr.BOF
        ...
        VSFlexGrid1.TextMatrix(X, 2) = IIf(IsNull(rsfindtr("amount")), "", rsfindtr("amount"))
        X = X + 1
        rsfindtr.MoveNext
Wend
rsfindtr.Close
