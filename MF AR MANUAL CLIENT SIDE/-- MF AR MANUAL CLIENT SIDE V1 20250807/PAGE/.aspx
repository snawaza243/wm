                            ...
                            <div class="row g-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="d-flex align-items-start flex-wrap gap-2 ms-4">
                                                ...
                                                <div class="form-check me-4">
                                                    <input class="form-check-input" type="radio" name="tranType" id="tranPMS" value="pms">
                                                    <label class="form-check-label" for="tranPMS">PMS</label>
                                                </div>

                                                <div class="form-check me-4">
                                                    <input class="form-check-input" type="radio" name="tranType" id="tranATM" value="atm">
                                                    <label class="form-check-label" for="tranATM">ATM</label>
                                                </div>

                                                <div class="form-check me-4">
                                                    <input class="form-check-input" type="radio" name="tranType" id="tranTA" value="trailActual">
                                                    <label class="form-check-label" for="tranTA">Trail Actual</label>
                                                </div>

                                                <div class="form-check me-3">
                                                    <input class="form-check-input" type="radio" name="tranType" id="tranSIP" value="sip">
                                                    <label class="form-check-label" for="tranSIP">NFO</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-2 ps-2">
                                    <div class="row g-3 ms-2">
                                        ...
                                        <%-- COUNT --%>
                                        <div class="col-md-12">
                                            <p class="text-danger fw-bold mt-4">Count: <span id="lblTrCount">0</span></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mt-4">
                                            <button type="button" id="btnTrFind" class="btn btn-sm btn-primary">Go</button>
                                            <button type="button" id="btnTrReset" class="btn btn-sm btn-outline-primary">Reset</button>
                                            <button type="button" id="btnTrExport" class="btn btn-sm btn-outline-primary">Export</button>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="d-flex align-items-center justify-content-end flex-wrap gap-3 mt-4">
                                            ...
                                            <button type="button" id="btnTrExit" class="btn btn-sm btn-outline-primary">Exit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <label for="txtSearching" class="form-label">Searching (Click Column You Want To Search)</label>
                                            <div class="input-group">
                                                <input type="text" id="txtSearching" class="form-control" />
                                                <button type="button" id="btnRtaFindByTr" class="btn btn-outline-primary" disabled>Find</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                                ...
                                                <button type="button" id="btnRtaConfPMS" class="btn btn-sm btn-outline-primary" onclick="confirmPMS()">Confirm PMS</button>
                                                <button type="button" id="btnRtaUncomfPMS" class="btn btn-sm btn-outline-primary" onclick="unconfirmPMS()">Unconfirm PMS</button>
                                                <button type="button" id="btnRtaReconsile" class="btn btn-sm btn-primary">Reconcile</button>
                                            </div>
                                        </div>
                                    </div>
...
`;
      ...
      `;
            ...
            function loadChannelList() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/masters/MfManualReconciliation.aspx/GetChannelList",
            ...
            function loadRegionList() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/masters/MfManualReconciliation.aspx/GetRegionList",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
            ...
            function loadBranchList() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/masters/MfManualReconciliation.aspx/GetBranchList", // Replace with actual ASPX page name
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (res) {
                        let { data } = JSON.parse(res.d);
            ...
            function loadZoneList() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/masters/MfManualReconciliation.aspx/GetZoneList", // Replace with actual ASPX page name
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (res) {
                        let { data } = JSON.parse(res.d);
            ...
            function loadAMCList() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/masters/MfManualReconciliation.aspx/GetAMCList", // Replace with actual ASPX page name
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (res) {
                        let { data } = JSON.parse(res.d);
            ...
            function loadRMList() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/masters/MfManualReconciliation.aspx/GetRmList", // Replace with actual ASPX page name
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (res) {
                        let { data } = JSON.parse(res.d);
            ...
            function loadBranchByChannel(channelCode) {
                ...
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/GetBranchListByChannel",
                    method: "POST",
            ...
            function loadBranchByZone(zoneCode) {
                ...
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/GetBranchListByZone",
                    method: "POST",
            ...
            function loadRegionByChannel(channelCode) {
                ...
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/GetRegionListByChannel",
                    method: "POST",
                    data: JSON.stringify({ channel: channelCode }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
            ...
            function loadZoneByChannel(channelCode) {
                ...
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/GetZoneListByChannel",
                    method: "POST",
                    data: JSON.stringify({ channel: channelCode }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
            ...
            function loadZoneByRegion(regionCode) {
                ...
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/GetZoneListByRegion",
                    method: "POST",
            ...
            function loadRMListByBrnach(value) {
                ...
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/GetRmListByBranch",
                    method: "POST",
            ...
            function loadTRList() {
                ...
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/GetTRList",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
...
`).join('');
            ...
            $("#btnTrReset").click(function () {
                window.location.href = '/Masters/MfManualReconciliation.aspx';
            });
            ...
            function loadRTAList() {
                ...
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/GetRTAList",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
 ...
 `);
            ...
            function onRtaSaveRemark(trCodeValue, txtRemarkValue) {
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/SaveRemark",
                    method: "POST",
                    data: JSON.stringify({
                        trCode: trCodeValue,
            ...
            function onConfirmPMSATM(trCode, remark, pmsStatus, atmStatus) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/masters/MfManualReconciliation.aspx/RtaConfirmPMS",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        trCode: trCode,
            ...
            function onUnconfirmPMSATM(trCode, remark, pmsStatus, atmStatus) {
                $.ajax({
                    type: "POST",
                    url: "/masters/MfManualReconciliation.aspx/RtaUnConfirmPMS",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        trCode: trCode,
            ...
            function onReconcileTransaction(trCode, rtaAmount, rtaCode, rtaDate, rtaFolio, dispatch, trType) {
                $.ajax({
                    type: "POST",
                    url: "/masters/MfManualReconciliation.aspx/ReconcileTransactions",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
            ...
            function loadTranList(tranCode) {
                $.ajax({
                    url: "/masters/MfManualReconciliation.aspx/GetTranList",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
