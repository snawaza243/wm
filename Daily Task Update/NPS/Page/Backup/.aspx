                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <asp:DropDownList ID="ddlPaymentMethod" runat="server" CssClass="form-select" onchange="togglePaymentFields()">
                                                ...
                                                <asp:ListItem Text="Non ECS" Value="M" />
...
onpaste="validatePaste(event, this);"
        ...
        <div id="SearchArModel" class="modal" style="z-index: 99">
            <div class="modal-content" style="width:100%">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <asp:TextBox ID="arPopArNo" runat="server" CssClass="form-control" MaxLength="12" />
                    </div>
                    <!-- Scheme -->
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <asp:TextBox ID="arPopChequeNo" runat="server" CssClass="form-control" MaxLength="20" />
                    </div>

                    <!-- Investor Name -->
                    <div class="col-md-4">
                        <label for="arPopInvName" class="form-label">Investor Name</label>
                        <asp:TextBox ID="arPopInvName" runat="server" CssClass="form-control" MaxLength="50" />
                    </div>
                    <!-- App No -->
                    <div class="col-md-1">
                        <label for="arPopAppNo" class="form-label">App No</label>
                        <asp:TextBox ID="arPopAppNo" runat="server" CssClass="form-control" MaxLength="50" />
                    </div>
...
onpaste="validatePaste(event, this);"
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:TextBox ID="arPopAnaExistCode" runat="server" CssClass="form-control" MaxLength="13" />
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group date" id="arPopFromDatePicker" data-date-format="dd/mm/yyyy">
                            <asp:TextBox ID="arPopArFromDate" runat="server" CssClass="form-control" placeholder="dd/mm/yyyy" MaxLength="10"/>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group date" id="arPopToDatePicker" data-date-format="dd/mm/yyyy">
                            <asp:TextBox ID="arPopArToDate" runat="server" CssClass="form-control" placeholder="dd/mm/yyyy" MaxLength="10" />
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
