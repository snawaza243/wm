...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <%-- Model css and form controll css --%>
    ...
    <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <%--<asp:TextBox runat="server" ID="txtDTNumber" CssClass="form-control border-dark" MaxLength="15" OnTextChanged="oneClientSearchByDT_Click" AutoPostBack="true"   />--%>
                                     <asp:TextBox runat="server" ID="txtDTNumber" CssClass="form-control border-dark"
                                        ...
                                        onkeydown="loaderByDtTab(event);" />

                                    <script>

                                        function loaderByDtTab(event) {
                                            if (event.key === "Tab") {
                                                showServerLoader();
                                                document.getElementById('<%= txtGuestCode.ClientID %>').focus();
                                            }
                                        }
                                    </script>
                                ...
                                <div>
                                    ...
                                    <div class="row g-3"> 
                                        ...
                                        <div class="col-md-3">
                                            <asp:Label runat="server" CssClass="form-label"
                                                Text="Enter AH Code" />
                                            <asp:TextBox runat="server" ID="txtSearchClientCode" CssClass="form-control" MaxLength="10" Text="" />
                                        </div>
                                ...
                                <div>
                                    ...
                                    <h3 class="card-title">2. Account Holder Information</h3>
                                        ...
                                        <Triggers>
                                            ...
                                            <asp:AsyncPostBackTrigger ControlID="ddlAOResidentNRI" EventName="SelectedIndexChanged" />
        ...
        document.getElementById("<%= txtOfficialEmail.ClientID %>")
                                                    ];
                                                    ...
                                                    fields.forEach(function (field) {
                                                        if (field) {
                                                            field.addEventListener("input", convertToLowerCase);
                                                            field.addEventListener("paste", function (event) {
                                                                setTimeout(() => {
                                                                    convertToLowerCase.call(this);
                                                                }, 0);
                                                            });

                                                            // Ensure default value is also converted
                                                            convertToLowerCase.call(field);
                                                        }
                                                    });
                                                });
                                            ...
                                            <asp:UpdatePanel id="upnlMobile" runat="server" UpdateMode="Conditional" EnableViewState="true">
                                                <ContentTemplate>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <asp:TextBox runat="server" ID="MobileNo" MaxLength="10" CssClass="form-control" />
                            ...
                            <div class="d-flex align-items-md-center flex-wrap flex-md-row flex-column gap-3">
                                <asp:Button runat="server"   ID="btnHiddenPostbackResetOnCreated"  OnClick="ResetFormFields1OnCreation" style="display:none;" />
                                <asp:Button runat="server" AccessKey="N" ID="btnNext" CssClass="btn btn-primary" Text="Next" OnClientClick="document.getElementById('other_details_tab').click(); return false;"   />
                                <asp:Button runat="server" AccessKey="R" ID="btnReset" CssClass="btn btn-outline-primary" Text="Reset" OnClick="ResetFields" OnClientClick="showServerLoader(); return true;"  />
                        ...
                        <div class="tab-pane fade pt-0" id="other_details" role="tabpanel" aria-labelledby="other_details_tab">
                            ...
                            <asp:Button runat="server" AccessKey="S" ID="btnSave" CssClass="btn btn-primary" Text="Save A/C" OnClick="btnInsert_Click" OnClientClick="showServerLoader(); return true;"/>
                            <asp:Button runat="server" AccessKey="M" ID="btnUpdate" CssClass="btn btn-primary" Text="Modify A/C" OnClick="btnUpdate_Click" OnClientClick="showServerLoader(); return true;" />
                            <asp:Button runat="server" AccessKey="A" ID="btnApprove"  CssClass="btn btn-outline-primary" Text="Approve" OnClick="ApproveButton_Click" OnClientClick="showServerLoader(); return true;" />
                            <asp:Button runat="server" AccessKey="B" ID="btnBack" CssClass="btn btn-outline-primary" Text="Back" OnClientClick="document.getElementById('basic_details_tab').click(); return false;"  />
                            <asp:Button runat="server"  ID="btnExitB" CssClass="btn btn-outline-primary" Text="Exit" OnClick="ExitButton_Click" OnClientClick="showServerLoader(); return true;"    />
