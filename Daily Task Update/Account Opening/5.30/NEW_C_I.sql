...
IF P_EXIST_CLIENT_CODE IS NULL OR P_EXIST_CLIENT_CODE = 0 THEN 
    ...
    INSERT INTO INVESTOR_MASTER ( 
        ...
        CITY_ID,  KYC,   SOURCE_ID,  RM_CODE,  REL_ID,   OCCUPATION_ID, TIMEST, LOGGEDUSERID) 
    VALUES (
        ...
        P_MAILING_CITY, 'YES', V_MYSOURCEID, P_EMP_RM, NULL, P_OCCUPATION, SYSDATE, P_LOGGED_IN_USER );
    COMMIT;
