                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList Enable="false" ID="selectEmployee" CssClass="form-select" runat="server">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <%--<asp:Button ID="btnResAddModelOpen" CssClass="btn btn-primary" data-toggle="modal" data-target="#resAddModal" runat="server" Text="Residence" OnClientClick="openResAddModal(); return false;" />--%>
                                    </div>
                                </div>
            ...
            <div class="row g-3 mt-2">
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <asp:TextBox ID="m_sas_txtMobile" CssClass="form-control" runat="server" placeholder="Enter Agent Mobile" />
                    </div>

                    <%-- SUPER ANA SEARCH phone --%>
                    <div class="col-md-2">
                        <label class="form-label" for="existcode">Phone</label>
                        <asp:TextBox ID="m_sas_txtPhone" CssClass="form-control" runat="server" placeholder="Enter Exist Phone"></asp:TextBox>
                    </div>
...
oninput="validatePanInput2(this)"
                    ...
                    <div class="col-md-2">
                        ...
                        <asp:TextBox ID="m_sas_txtAgentCode" CssClass="form-control" runat="server" placeholder="Enter Agent Code" />
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12 d-flex justify-content-end align-items-end mt-4 gap-1">
                            <asp:Button
                                ID="btnSearch"
