        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    string selectedNationality = ddlAONationality.SelectedValue;
                    fun_NriByNationality(ddlAONationality.SelectedValue);
...
";
        ...
        {
            string selectedNationality = ddlAONationality.SelectedValue;
            fun_NriByNationality(selectedNationality);



        }

        public void fun_NriByNationality(string selectedNationality)
        {

            bool isNRI = selectedNationality == "NRI";
...
AadharValue
    ...
    AadharValue
        ...
        private void SetFieldData(DataRow row)
        {
            ...
            fun_NriByNationality(db_nationality_value);
