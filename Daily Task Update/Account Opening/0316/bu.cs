...
";
        ...
        private void UpdateBusinessCodeDetails(string businessCode)
        {
            ...
            {
                psm_controller.ShowAlert(this, "Error while fetching data by Business Code " + ex.Message);
            }
    ...
    AadharValue
        ...
        protected void INSERT_CLIENT_DATA()
        {
            try
            {
                ...
                // if dt null then return 
                if (string.IsNullOrEmpty(dtNumberValue))
                {
...
loggedinUser
        ...
        protected void ApproveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                psm_controller.ShowAlert(this, "Error while Approving " + ex.Message);
                ScriptManager.RegisterStartupScript(this, this.GetType(), "hideServerLoader", "hideServerLoader();", true);
                return;
            }
            finally
