                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <asp:TextBox runat="server" ID="MobileNo" MaxLength="20" CssClass="form-control" />
                                                <script>
                                                    document.addEventListener("DOMContentLoaded", function () {
                                                        var ddlNationality = document.getElementById("<%= ddlAONationality.ClientID %>");
                                                        var txtMailingPin = document.getElementById("<%= txtMailingPin.ClientID %>");
                                                        ...
                                                        function setMaxLength() {
                                                            ...
                                                            txtMobileNo.maxLength = ddlNationality.value === "NRI" ? 19 : 10;
                                                        }
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mt-2 gap-3">
                                                            ...
                                                            <asp:Button runat="server" Enabled="true" ID="btnAdvPrint"
                                                                CssClass="btn btn-primary" Text="Print AR"
                                                                OnClick="btnPrintARReport_Click" />
                                                            <asp:Button runat="server" Enabled="true" ID="btnAdvUpdate"
