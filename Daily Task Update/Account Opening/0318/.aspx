<%@ Page Title=" Account Opening" Language="C#" AutoEventWireup="true" CodeBehind="AccountOpening.aspx.cs" Inherits="WM.Masters.AccountOpening" MasterPageFile="~/vmSite.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" EnableViewState="true" %>
                                                ...
                                                <script>
                                                    document.addEventListener("DOMContentLoaded", function () {
                                                        ...
                                                        function setMaxLength() {
                                                            ...
                                                            txtMobileNo.maxLength = ddlNationality.value === "NRI" ? 18 : 10;
                                                        }
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mt-2 gap-3">
                                                            <asp:Button runat="server" Enabled="true" ID="btnAdvGenerate"
