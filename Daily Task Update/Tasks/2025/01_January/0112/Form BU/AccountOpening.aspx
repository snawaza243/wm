...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div id="ClientListClientListModal" class="modal" role="dialog" style="padding: 0 0 0 20%; z-index: 99">
                                    ...
                                    <div class="row">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <asp:TextBox ID="ClientListphone" runat="server" CssClass="form-control phone-input" />
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <asp:TextBox ID="ClientListbusinessCd" runat="server" MaxLength="10" CssClass="form-control" />
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-center mt-4 gap-2 flex-wrap">
                                                    <asp:Button ID="ClientListbtnSearch" runat="server" CssClass="btn btn-primary" Text="Search" OnClick="ClientListSearch_Click" />
                                                    <asp:Button ID="ClientListbtnReset" runat="server" CssClass="btn btn-outline-primary" Text="Reset" OnClick="ClientListReset_Click" />
                                                    <asp:Button ID="ClientListbtnExit" runat="server" CssClass="btn btn-outline-primary" Text="Exit" OnClientClick="closeClientListModal(); return false;" />
                                                </div>
                                            </div>
                                        </div>
                                        <br />
                        ...
                        <div id="InvestorListModal" class="modal" role="dialog" style="padding: 0 0 0 20%; z-index: 99">
                            <div class="modal-content">
    ...
    <!-- DOB Input -->
    <div class="col-md-3">
        <label for="InvestorListDOB" class="form-label">DOB</label>
        <div class="input-group date" data-provide="datepicker">
            <asp:TextBox ID="InvestorListDOB" runat="server" CssClass="form-control" 
    ...
    <div class="col-md-3">
        ...
        <asp:TextBox ID="InvestorListPan" runat="server" CssClass="form-control" 
                        MaxLength="10" 
 
            ToolTip="Enter PAN Number" aria-label="PAN" />
    </div>
    ...
    <Columns>
        ...
        <%--<asp:TemplateField HeaderText="Investor ID" ItemStyle-CssClass="column-width-90 d-none">
            <ItemTemplate>
                <asp:Label ID="InvestorListIdLabel" runat="server" Text='<%# Eval("INV_CODE") %>' />
            </ItemTemplate>
        </asp:TemplateField>--%>
                ...
                <asp:Label ID="InvestorListDobLabel" runat="server" Text='<%# Eval("DOB", "{0:dd-MMM-yyyy}") %>' />
                    ...
                    <ul class="nav nav-tabs wmTabs" id="wmTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="basic_details_tab" data-bs-toggle="tab" href="#basic_details" role="tab" aria-controls="basic_details" aria-selected="true">Basic Details </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="other_details_tab" data-bs-toggle="tab" href="#other_details" role="tab" aria-controls="other_details" aria-selected="false">Other Details
                            </a>
                        </li>
                    </ul>
                    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
        // Set active tab based on sessionStorage on page load
        $(document).ready(function () {
            ...
            // Store active tab in sessionStorage on tab click
        ...
        <asp:Label runat="server" ID="ApprovalStatus" CssClass="form-label" Text="--"></asp:Label>
                                ...
                                <div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            <asp:Label runat="server" CssClass="form-label"
                                                ID="txtClientCodeLabel" Text="Client Search" />
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-3">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlAOCategoryStatus" CssClass="form-select">
                                                ...
                                                <asp:ListItem Text="HUF" Value="HUF" />
                                                <asp:ListItem Text="Company" Value="COMPANY" />
                                                <asp:ListItem Text="Trust" Value="TRUST" />
                                                <asp:ListItem Text="Society" Value="SOCIETY" />
                                                <asp:ListItem Text="Bajaj Capital Staff" Value="BAJAJ CAPITAL STAFF" />
                                            </asp:DropDownList>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlAOClientCategory" CssClass="form-select">
                                                <%--         <asp:ListItem Text="Select Client Category" Value="" />
                                                <asp:ListItem Text="HNI	- High Networth Income" Value="4001" />
                                                <asp:ListItem Text="MNI -	Medium Networth Income" Value="4002" />
                                                <asp:ListItem Text="Retail" Value="4003" />
                                                <asp:ListItem Text="Corporate" Value="4004" />
                                                <asp:ListItem Text="Others" Value="4005" />--%>
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-3">
                                            <asp:Label runat="server" CssClass="form-label"
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlAOACCategory" CssClass="form-select">
                                                ...
                                                <asp:ListItem Text=">5 Cr" Value="4" />
                                                <asp:ListItem Text="2-5 Cr" Value="3" />
                                                <asp:ListItem Text="50 Lacs-2 Cr" Value="2" />
                                                <asp:ListItem Text="<50 Lacs" Value="1" />
                                                <asp:ListItem Text="Retails" Value="0" />
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlAOResidentNRI" CssClass="form-select">
                                                <asp:ListItem Text="Select Resident/NRI" Value="" />
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group date" data-provide="datepicker">
                                                ...
                                                <asp:TextBox ID="cldDOB" runat="server" CssClass="form-control" OnTextChanged="cldDOB_TextChanged" AutoPostBack="true" />
                                        ...
                                        <div class="col-md-3">
                                            <asp:Label runat="server" CssClass="form-label" Text="PAN <span class='text-danger'>*</span>" />
                                            <asp:TextBox runat="server" ID="itfAOClientPan" oninput="validatePanInput(this)" MaxLength="10" CssClass="form-control" />
                                        </div>
                                        <div class="col-md-3">
                                            <asp:Label runat="server" CssClass="form-label"
                                                Text="Lead Source" />
                                ...
                                <div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-3">
                                            ...
                                            <asp:TextBox runat="server" ID="itfAOGuardianPerson" CssClass="form-control" MaxLength="100" />
                                        </div>
                                        <div class="col-md-3">
                                            <asp:Label runat="server" CssClass="form-label"
                                                Text="Nationality" />
                                            <asp:TextBox runat="server" ID="itfAOGuardianNationality" CssClass="form-control" MaxLength="20"/>
                                        </div>
                                        <div class="col-md-3">
                                            <asp:Label runat="server" CssClass="form-label"
                                                Text="PAN " />
                                            <asp:TextBox runat="server" ID="itfAOGuardianPANNO" oninput="validatePanInput(this)" MaxLength="10" CssClass="form-control" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <script>
                                            function validatePinCode(input, maxLength = 10, countryFlag = "<%= ddlMailingCountryList.ClientID %>") {
                                                // Get the client ID of the dropdown control from the server-side control
                                                var countryDropDown = document.getElementById(countryFlag).value;

                                                // Regular expression for numeric characters only
                                                var regexNumeric = /^[0-9]*$/;

                                                // If the country is India, enforce numeric and 6 digits
                                                if (countryDropDown.toUpperCase() === "INDIA") {
                                                    // Check if the length is not exactly 6 characters
                                                    if (input.value.length > 6) {
                                                        alert("The pin code for India should be exactly 6 digits.");
                                                        input.value = input.value.slice(0, 6);  // Trim the input to 6 digits
                                                        return;
                                                    }

                                                    // Check if all characters are numeric
                                                    if (!regexNumeric.test(input.value)) {
                                                        alert("The pin code for India can only contain numeric digits.");
                                                        input.value = input.value.slice(0, -1);  // Remove the last character
                                                        input.focus();
                                                    }
                                                } else {
                                                    // For other countries, allow up to 20 alphanumeric characters
                                                    if (input.value.length > 20) {
                                                        alert("The pin code cannot exceed 20 characters.");
                                                        input.value = input.value.slice(0, 20);  // Trim the input to 20 characters
                                                        return;
                                                    }

                                                    // Check if the last character is numeric (optional check for non-numeric values)
                                                    var lastChar = input.value.slice(-1);
                                                    if (!regexNumeric.test(lastChar) && lastChar !== "") {
                                                        alert("The character '" + lastChar + "' is not allowed. Only numeric or alphanumeric characters are permitted.");
                                                        input.value = input.value.slice(0, -1);  // Remove the last character
                                                        input.focus();
                                                    }
                                                }
                            ...
                            <div class="d-flex align-items-md-center flex-wrap flex-md-row flex-column gap-3">
                                <asp:Button runat="server" ID="btnSave" CssClass="btn btn-primary" Text="Save" OnClick="btnInsert_Click" />
                                ...
                                <asp:Button runat="server" ID="btnNext" CssClass="btn btn-primary" Text="Next" OnClientClick="document.getElementById('other_details_tab').click(); return false;" />
                        ...
                        <div class="tab-pane fade" id="other_details" role="tabpanel"
                            aria-labelledby="other_details_tab">
                            ...
                            <div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Label runat="server" CssClass="form-label" Text="Mobile" />
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label runat="server" CssClass="form-label" Text="PAN" />
                                        <asp:TextBox runat="server" ID="addfamPan" CssClass="form-control" oninput="validatePanInput(this)" MaxLength="10" />
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Label runat="server" CssClass="form-label" Text="DOB" class="text-danger" />


                                        <div class="input-group date" data-provide="datepicker">
                                            <asp:TextBox ID="addfamDOB" runat="server" CssClass="form-control" OnTextChanged="addfamDOB_TextChanged" AutoPostBack="true" />
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="glyphicon glyphicon-th"></i></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:DropDownList runat="server" ID="addfamGender" CssClass="form-select">
                                            ...
                                            <asp:ListItem Text="Non-IND" Value="O" />
                                        </asp:DropDownList>
                                    </div>
                                  
                                    <div class="col-md-2">
    <asp:Label runat="server" CssClass="form-label" Text="Guardian PAN" />
    <asp:TextBox runat="server" ID="addfamGuardianPan" CssClass="form-control" oninput="validatePanInput(this)" MaxLength="10" />
</div>
                                    <div class="col-md-4">
                                        <asp:Label runat="server" CssClass="form-label" Text="Guardian Name" />
                                        <asp:TextBox runat="server" ID="addfamGuardianName" CssClass="form-control" MaxLength="50" />
                                    </div>
                                    <div class="col-md-3">
                                        <asp:Label runat="server" CssClass="form-label" Text="Occupation" />
                                    ...
                                    <div class="col-md-3">
                                        <asp:Label runat="server" CssClass="form-label" Text="Relation" />
                                    ...
                                    <div class="col-md-7 mt-4">
                                        ...
                                        <asp:Button runat="server" CssClass="btn btn-success" Text="Add" ID="AddMemberButton" OnClick="AddMemberButton_Click" AutoPostBack="true" />
                                        <asp:Button runat="server" CssClass="btn btn-warning" Text="Update" ID="UpdateMemberButton" OnClick="UpdateMemberButton_Click" Enabled="false" />
                                        <asp:Button runat="server" CssClass="btn btn-warning" Text="Reset" ID="ResetMemberButton" OnClick="ResetMemberButton_Click"  />
                                ...
                                <asp:Label runat="server" ID="lblMessageAddFam" CssClass="text-danger" Text="Info: " />
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <asp:TextBox runat="server" ID="txtAmount" 
                                                        ...
                                                        oninput="validateAmount(this)" TextMode="Number" />
                                                    <script>
                                ...
                                <div>
                                    ...
                                    <div class="row g-3">
                                        <div class="mt-5 gap-3">
                                            ...
                                            <asp:Button runat="server" CssClass="btn btn-outline-primary" Text="Back" OnClientClick="document.getElementById('basic_details_tab').click(); return false;" />
