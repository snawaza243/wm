...
begin
    ...
    INSERT INTO AGENT_MASTER (
        ...
        AGENT_MASTER.r_address1,  AGENT_MASTER.r_address2,  AGENT_MASTER.r_state_name, AGENT_MASTER.r_city_name, AGENT_MASTER.r_pincode, DOC_ID

    ) VALUES (
      P_LOGGEDINUSER,              P_EMPANELMENTTYPE,       upper(P_AGENTNAME),              P_SOURCEID,             P_RMCODE,             upper(P_ADDRESS1),            upper(P_ADDRESS2),
      ...
      P_BRANKBRANCHID,             P_SMSFLAG,               P_GSTINNO,                P_DOB,                  P_AGENTTYPE,          P_PAN,                  P_DIST,     
      ...
      upper(P_RES_ADD_1),          upper(P_RES_ADD_2),      upper(P_RES_ADD_STATE),   upper(P_RES_ADD_CITY),   trim(P_RES_ADD_PINCODE), trim(P_DT_NUMBER)
