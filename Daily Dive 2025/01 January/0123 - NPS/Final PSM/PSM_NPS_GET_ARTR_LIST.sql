create or replace PROCEDURE PSM_NPS_GET_ARTR_LIST (
    ...
    p_ar_from_date     IN DATE DEFAULT NULL,
    p_ar_to_date       IN DATE DEFAULT NULL,
        ...
        OPEN p_result_cursor FOR
            ...
            WHERE 
              ...
              --  AND (p_investor_name IS NULL OR UPPER(p_investor_name) LIKE '%' || UPPER(INV_NAME) || '%')
                ...
                AND (p_ar_from_date IS NULL OR tr_date >= p_ar_from_date)
                AND (p_ar_to_date IS NULL OR tr_date <= p_ar_to_date)
