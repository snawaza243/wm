...
BEGIN
   ...
   SELECT                                                                ar_branch_cd,
    ...
    and  COMPANY_CD = p_company_code
     
        AND importdatatype = 'DUEDATA'
      AND ( (p_policy_number IS NOT NULL AND POLICY_NO = p_policy_number) OR (p_policy_number IS NULL AND mon_no = p_month AND year_no = p_year))
      and rownum <10
