create or replace PROCEDURE PSM_DAP_INSERT_N_BDD (
    ...
    p_FREQ              IN BAJAJ_DUE_DATA.FREQ%TYPE,
...
BEGIN
  ...
  BEGIN
    INSERT INTO BAJAJ_DUE_DATA (
        ...
        p_PLY_TERM, p_CL_ADD4, p_CL_ADD5, p_PLAN_NO, p_BPREM_FREQ, p_PREM_TERM, p_LAST_UPDATE_DT,
        ...
        p_MATCHED, p_REN_STATUS, p_REMARKS, p_IMPORTDATATYPE, p_HISTORY, p_SYS_AR_NO_REN, p_AUTOMAP,
        p_CLIENT_CD, p_INV_CODE, p_P_NAME, p_I_NAME, p_SA, p_REM_FLAGE, p_STATE_CD, p_COMM, p_COMM_AMT,
        p_BASE_SYS_AR_NO, p_MATCH_HEADER, p_CPREM_FREQ, p_MATCH_HEADER1, NULL /* p_NEWINSERT */, p_SLOT,
        ...
        p_ISTATE_CD, p_IPIN, p_PLAN_RATE4, p_PAID_MONTH_YEAR, p_STATUS_CD_OLD, p_FREQ, p_FRESH_RENEWAL,
