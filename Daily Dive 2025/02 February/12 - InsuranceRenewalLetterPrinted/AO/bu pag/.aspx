...
oninput="validatePanInput2(this)" aria-label="PAN" />
    ...
    <div>
                                ...
                                <div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group date" data-provide="datepicker">
                                                <asp:TextBox ID="cldDOB" runat="server" CssClass="form-control" MaxLength="10"
                                                    onchange="return onChangeValidateFamActiveHead(this)"
                                                    oninput="formatDOBInput(this)" />
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><i class="glyphicon glyphicon-th"></i></span>
                                                </div>
     ...
     oninput="validatePanInput2(this)">
                        ...
                        <div class="tab-pane fade pt-0" id="other_details" role="tabpanel"
