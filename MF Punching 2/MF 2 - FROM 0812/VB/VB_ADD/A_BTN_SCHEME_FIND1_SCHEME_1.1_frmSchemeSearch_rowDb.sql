CREATE OR REPLACE PROCEDURE PSMM_SCH_SEARCH_GET_ROW_DB (
    PX_ROW_DATA   IN VARCHAR2,
    strscheme    IN VARCHAR2,
...
BEGIN
  ...
  IF PX_COL2 IS NOT NULL THEN
    ...
    ELSIF strscheme = 'frmBrokRecdSlabs' THEN
    ...
    ELSIF strscheme = 'frmBrokRecdSlabsRIO' THEN
    ...
    ELSIF strscheme = 'frmtransactionmf' THEN
      V_TR_MF1_A_AMC:= PX_COL4;

      IF PX_OTHER1 = PX_COL3 THEN
        V_TR_MF3_SCH:= PX_COL3;
      END IF;
    ...
    ELSIF strscheme = 'FrmNfoSchemes' THEN
