...
namespace WM.Controllers
{
    public class MfPunchingController
    {
        ...
        public DataTable MF2_GetTrX(string tabIndex, string businessRmCodeA, string branches,string logId, string roleId, string fromDate, string toDate, string panS,string clientS, string tranNo, string anaCode, string chequeNo, string appNo,string installments, string sipType, string clientCode, string acHolderCode,string businessRmCodeM, string panM, string frequencyCode, string orderBy,string descending)
        {
            ...
            {
                using (OracleCommand cmd = new OracleCommand("PSM_MF2_VIEW_TR", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;

                    // Input parameters - ALL 22 parameters in correct order
                    cmd.Parameters.Add("P_TAB_INDEX", OracleDbType.Varchar2).Value = tabIndex;
                    cmd.Parameters.Add("P_BUSINESS_RMCODE_A", OracleDbType.Varchar2).Value = businessRmCodeA ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_BRANCHES", OracleDbType.Varchar2).Value = (object)DBNull.Value;// branches ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_LOG_ID", OracleDbType.Varchar2).Value = logId ?? (object)DBNull.Value;
                    ...
                    cmd.Parameters.Add("P_PAN_S", OracleDbType.Varchar2).Value = panS ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_CLIENT_S", OracleDbType.Varchar2).Value = clientS ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_TRAN_NO", OracleDbType.Varchar2).Value = tranNo ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_ANA_CODE", OracleDbType.Varchar2).Value = anaCode ?? (object)DBNull.Value;
                    ...
                    cmd.Parameters.Add("P_INSTALLMENTS", OracleDbType.Varchar2).Value = installments ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_SIP_TYPE", OracleDbType.Varchar2).Value = sipType ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_CLIENT_CODE", OracleDbType.Varchar2).Value = clientCode ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_AC_HOLDER_CODE", OracleDbType.Varchar2).Value = acHolderCode ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_BUSINESS_RMCODE_M", OracleDbType.Varchar2).Value = businessRmCodeM ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_PAN_M", OracleDbType.Varchar2).Value = panM ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_FREQUENCY_CODE", OracleDbType.Varchar2).Value = frequencyCode ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_ORDER_BY", OracleDbType.Varchar2).Value = orderBy ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_DESCENDING", OracleDbType.Varchar2).Value = descending;
        ...
        public (bool Success, string Message, Dictionary<string, object> Data) ProcessMfTransactionDocByDT(string index, string commonId, string chkSwitch)
        {
            ...
            using (OracleConnection conn = new OracleConnection(WebConfigurationManager.ConnectionStrings["ConnectionStringVM"].ConnectionString))
            {
                using (OracleCommand cmd = new OracleCommand("WEALTHMAKER.PSM_MF2_GET_BY_DT", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;

                    cmd.Parameters.Add("P_INDEX", OracleDbType.Varchar2).Value = index ?? (object)DBNull.Value;
                    ...
                    cmd.Parameters.Add("P_ROLE_ID", OracleDbType.Varchar2).Value = roleId ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_CHK_SWITCH", OracleDbType.Varchar2).Value = chkSwitch ?? (object)DBNull.Value;
                    ...
                    try
                    {
                        ...
                        using (var reader = ((OracleRefCursor)outCursor.Value).GetDataReader())
                        {
                            if (reader.Read())
                            {
                                ...
                                string message = reader["V_RETURN_MESSAGE"]?.ToString() ?? "No message returned";

                                bool isSuccess = message.StartsWith("SUCCESS:");

                                // Collect extra fields if available
        ...
        public (bool Success, string Message, Dictionary<string, object> Data) ProcssMF2_BusiCodeLostFocuse(string busiCode, string invCode, string allIndia, string allIndiaSearchLag, string branches)
        {
            string loginId = pc.currentLoginID();
            string currentRole = pc.currentRoleID();
            var data = new Dictionary<string, object>();

            using (OracleConnection conn = new OracleConnection(WebConfigurationManager.ConnectionStrings["ConnectionStringVM"].ConnectionString))
            {
                using (OracleCommand cmd = new OracleCommand("WEALTHMAKER.PSM_MF2_BUSI_CODE_LOST_F", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;

                    // Input parameters
                    cmd.Parameters.Add("PRM_BUSI_CODE", OracleDbType.Varchar2).Value = busiCode ?? (object)DBNull.Value;
                    cmd.Parameters.Add("PRM_INV_CODE", OracleDbType.Varchar2).Value = invCode ?? (object)DBNull.Value;
                    cmd.Parameters.Add("PRM_ALL_INDIA", OracleDbType.Varchar2).Value = allIndia ?? (object)DBNull.Value;
                    cmd.Parameters.Add("PRM_ALL_INDIA_SEARCH_LAG", OracleDbType.Varchar2).Value = allIndiaSearchLag ?? (object)DBNull.Value;
                    cmd.Parameters.Add("PRM_BRANCHES", OracleDbType.Varchar2).Value = branches ?? (object)DBNull.Value;
                    cmd.Parameters.Add("PRM_LOG", OracleDbType.Varchar2).Value = loginId ?? (object)DBNull.Value;
                    cmd.Parameters.Add("PRM_ROLE", OracleDbType.Varchar2).Value = currentRole ?? (object)DBNull.Value;

                    // Output cursor
                    var outCursor = new OracleParameter("PRM_CURSOR", OracleDbType.RefCursor)
                    {
                    ...
                    try
                    {
                        ...
                        using (var reader = ((OracleRefCursor)outCursor.Value).GetDataReader())
                        {
                            ...
                            {
                                // Always return the message
                                string message = reader["V_MSG"]?.ToString() ?? "No message returned";
                                bool isSuccess = message.StartsWith("SUCCESS:");

                                // Collect all fields from the reader
                                for (int i = 0; i < reader.FieldCount; i++)
                                {
                                    string colName = reader.GetName(i);
                                    object colValue = reader.IsDBNull(i) ? null : reader.GetValue(i);
        ...
        #region GET MF VIEW AR LOGGED STATUS
        public static object StringOrDBNull(string input)
        {
            return string.IsNullOrEmpty(input) ? DBNull.Value : (object)input;
        }
        public string GET_MF_VIEW_AR_LOGGED_STATUS(string inv_code = null, string tran_code = null, string dt = null)
        {
            try
            {
                string result = string.Empty;
                DataTable resultTable = new DataTable(); // Declare the DataTable

                using (OracleCommand command = new OracleCommand("psm_mf_view_ar_loge_status", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;

                    // Input parameters
                    command.Parameters.Add("P_TRAN_CODE", OracleDbType.Varchar2).Value = StringOrDBNull(tran_code);

                    command.Parameters.Add("P_INV_CODE", OracleDbType.Varchar2).Value = StringOrDBNull(inv_code);
                    command.Parameters.Add("P_DT_NUMBER", OracleDbType.Varchar2).Value = StringOrDBNull(dt);
                    ...
                    // Open connection and fill DataTable
                    connection.Open();
                ...
                // Read the MF_VIEW_STATUS column value
                if (resultTable.Columns.Contains("MF_VIEW_STATUS") && resultTable.Rows.Count > 0)
                {
                    result = resultTable.Rows[0]["MF_VIEW_STATUS"].ToString();
                }
                else
                {
                    result = string.Empty;
            ...
            {
                throw new Exception("Error fetching MF View AR Logged Status: " + ex.Message);
            }
        }
        ...
        public DataTable GetTransactionList(TransactionFilter filter)
        {
            ...
            PsmController psmController = new PsmController();
            ...
            using (OracleConnection conn = new OracleConnection(connectionString))
            {
                using (OracleCommand cmd = new OracleCommand("Get_Transactions_mf_punc", conn))
                {
                    ...
                    string tmepLog = psmController.currentLoginID() ?? null;
                    string tempRole = psmController.currentRoleID() ?? null;

                    cmd.Parameters.Add("P_NEW_LOGIN_ID", OracleDbType.Varchar2).Value = psmController.currentLoginID() ?? (object)DBNull.Value;
                    cmd.Parameters.Add("P_NEW_ROLE_ID", OracleDbType.Varchar2).Value = psmController.currentRoleID() ?? (object)DBNull.Value;

                    cmd.Parameters.Add("p_isView", OracleDbType.Varchar2).Value = "1";
    ...
    string swpFlag, string freedomSipFlag, string loggedInUser, string microflag)
      ...
      DateTime? dropDate,
       ...
       string sipSubType
            ...
            using (OracleConnection con = new OracleConnection(WebConfigurationManager.ConnectionStrings["ConnectionStringVM"].ConnectionString))
            {
                try
                {
                    ...
                    using (OracleCommand cmd = new OracleCommand("ModifyTransactionPUNCHINGPRA", con))
                    {
                        ...
                        cmd.Parameters.Add("p_sip_sub_type", OracleDbType.Varchar2).Value = sipSubType;
        ...
        public DataTable NewInvDataForTrInvUpdate(string curInv, string curTr, string newInv)
        {
            DataTable dt = new DataTable();

            string conString = WebConfigurationManager.ConnectionStrings["ConnectionStringVM"].ConnectionString;
            using (OracleConnection conn = new OracleConnection(conString))
            {
                using (OracleCommand cmd = new OracleCommand("WEALTHMAKER.PSM_MFV_GET_INV_DATA", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("P_CUR_INV", OracleDbType.Varchar2).Value = curInv;
                    cmd.Parameters.Add("P_CUR_TR", OracleDbType.Varchar2).Value = curTr;
                    cmd.Parameters.Add("P_NEW_INV", OracleDbType.Varchar2).Value = newInv;
                    cmd.Parameters.Add("P_LOGIN", OracleDbType.Varchar2).Value = pc.currentLoginID();
                    cmd.Parameters.Add("P_ROLE", OracleDbType.Varchar2).Value = pc.currentRoleID();
                    cmd.Parameters.Add("P_CURSOR", OracleDbType.RefCursor).Direction = ParameterDirection.Output;
