        ...
        <div class="col-md-12 grid-margin stretch-card">
                            ...
                            <asp:UpdatePanel ID="UpdatePanelFillByDT" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div> 
                                                ...
                                                <div class="row g-3">                                                
                                                    ...
                                                    <%-- cross channel model --%>
                                                    <div class="modal fade" id="CrossChannelModal"  aria-labelledby="addresModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content bg-white">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5" id="CrossChannelModalLabel">Cross Channel Alert</h1>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <asp:Label runat="server" ID="Label21" CssClass="mb-2 text-primary d-block"></asp:Label>
                                                                        </div>

                                                                        <div class="col-12">

                                                                            <div class="table-responsive">
                                                                                <%--<asp:GridView runat="server" ID="GridCrossChannel" EmptyDataText="No data found" CssClass="table"></asp:GridView>--%>
                                                                                <asp:GridView runat="server" ID="gvCrossChannel" AutoGenerateColumns="true" CssClass="table" EmptyDataText="No data found"></asp:GridView>
                                                                ...
                                                                <div class="modal-footer justify-content-center">
                                                                    <asp:Button runat="server" ID="BtnContinueCross" CausesValidation="false" Text="Continue" CssClass="btn btn-primary btn-sm me-2" OnClick="BtnContinueCross_Click" />
                                                                    <asp:Button runat="server" ID="BtnCrossChannelApproval" CausesValidation="false" Text="Send Approval" CssClass="btn btn-primary btn-sm" OnClick="BtnCrossChannelApproval_Click" />
                                                                    <asp:HiddenField runat="server" ID="HiddenField1" ClientIDMode="Static" />
                                                                    <asp:HiddenField runat="server" ID="HdnIsCrossContinue" ClientIDMode="Static" />
                                                                    <asp:HiddenField runat="server" ID="hdnVehSCE" ClientIDMode="Static" />
                                                                    <asp:HiddenField runat="server" ID="hdnModelId" ClientIDMode="Static" />
                                                                    <asp:HiddenField runat="server" ID="hdnVariantId" ClientIDMode="Static" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal fade" style="width:80%" id="addresModal" tabindex="-1" aria-labelledby="addresModalLabel" aria-hidden="true">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row g-3">
                                                                        <div class="col-6">
                                                                            ...
                                                                            <asp:TextBox runat="server" ID="AddTextAddress1" CssClass="form-control"></asp:TextBox>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <label class="form-label">Address2</label>
                                                                            <asp:TextBox runat="server" ID="AddTextAddress2" CssClass="form-control" ></asp:TextBox>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <label class="form-label">City</label>
                                                                            <asp:DropDownList runat="server" ID="DropDownCity" ClientIDMode="Static" CssClass="form-select"  >
                                                                        ...
                                                                        <div class="col-6">
                                                                            ...
                                                                            <asp:DropDownList runat="server" ID="DropDownState" ClientIDMode="Static" CssClass="form-select" >
                                        ...
                                        <%-- TB: SIP START DATE --%>
                                        <div class="col-md-6">
                                            <asp:Label ID="lblSIPStartDate" runat="server" CssClass="form-label" AssociatedControlID="txtSIPStartDate" Text="SIP Start Date A" />
                                            <div class="date" data-provide="datepicker" data-date-format="dd/mm/yyyy">
                                        ...
                                        <%-- TB: SIP End Date --%>
                                        <div class="col-md-6">
                                            <asp:Label ID="lblSIPEndDate" runat="server" CssClass="form-label" AssociatedControlID="txtSIPEndDate" Text="SIP End Date A" />
                                            <div class="date" data-provide="datepicker" data-date-format="dd/mm/yyyy">
            ...
            '<%= hdncountryid.ClientID %>'
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" CssClass="panel panel-default draggable"
                                        Style="display: none; position: fixed; top: 20%; left: 30%; width: 50%; max-height: 500px; overflow: auto; background-color: white; border: 1px solid #ccc; z-index: 1000; padding: 15px;">
                                        <div class="panel-heading" style="cursor: move; display: flex; justify-content: space-between; align-items: center;">
                                            <h4 class="panel-title">Investor Address Updation 1</h4>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="txtDOBADD" runat="server" CssClass="form-control" placeholder="dd/mm/yyyy" />
                                                    </div>
                                                </div>
          ...
          <asp:TextBox ID="txtEmailADD" runat="server" onblur="handleBlur(this)" oninput="validateEmailInput(this)" CssClass="form-control" Style="margin-bottom: 10px;"></asp:TextBox>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList ID="ddlCityADD" runat="server" CssClass="form-control p-3" AutoPostBack="True" OnSelectedIndexChanged="ddlCity_SelectedIndexChanged"  >
                                                            <asp:ListItem Text="--Select city--" Value="" />
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList ID="ddlStateADD" runat="server" CssClass="form-control p-3"  >
                                                            <asp:ListItem Text="--Select state--" Value="" />
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="tableSearchResults" CssClass="table table-bordered" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="MICROSIP">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblM_FIND_AR_SIP_SUP_TYPE" runat="server" Text='<%# Eval("microsip") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div id="tranDetails" runat="server">
                                        ...
                                        <div class="row g-3 mb-3">
                                            ...
                                            <div class="col-md-2">
                                                <label for="sipStp" class="form-label">SIP/STP M</label>
                                            ...
                                            <!-- SIP Type -->
                                            <div class="col-md-3">
                                                <asp:Label ID="lblM_SIPSubType" runat="server" CssClass="form-label" AssociatedControlID="ddlM_SIPSubType" Text="SIP Type" Visible="false" />
                                                <div class="date" data-provide="datepicker" data-date-format="">
                                                    <asp:DropDownList ID="ddlM_SIPSubType" runat="server" CssClass="form-control p-3" Visible="false">
                                                        <asp:ListItem Value="N" Text="NORMAL" />
                                                        <asp:ListItem Value="Y" Text="MICROSIP" />
                                                    </asp:DropDownList>
                                                </div>
                                                    ...
                                                    <ContentTemplate>
                                                        ...
                                                        <div class="container">
                                                            <div class="row mb-3">
                                                                ...
                                                                <!-- SIP Start Date -->
                                                                <div class="col-md-6">
                                                                    <asp:Label ID="lblSIPStartDateupdate" runat="server" CssClass="form-label" AssociatedControlID="txtSIPStartDateupdate" Text="SIP Start Date M" Visible="false" />
                                                                    <div class="date" data-provide="datepicker" data-date-format="dd/mm/yyyy">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <!-- SIP End Date -->
                                                                <div class="col-md-6">
                                                                    <asp:Label ID="lblSIPEndDateupdate" runat="server" CssClass="form-label" AssociatedControlID="txtSIPEndDateupdate" Text="SIP End Date M" Visible="false" />
                                                                    <div class="date" data-provide="datepicker" data-date-format="dd/mm/yyyy">
...
<td>${totalAmount.toFixed(2)}</td>
    ...
    <script>
        // HideCrossChannelModal()

        function HideCrossChannelModal() {

            var modal = document.getElementById('CrossChannelModal');
            if (modal) {
        ...
        // ShowCrossChannelModal()
        function ShowCrossChannelModal() {
            var modal = document.getElementById('CrossChannelModal');
            if (modal) {
