...
'Sqlstr = Sqlstr & " and B.mon_no=" & mon_no & " and b.year_no=" & year_no & " "
'Sqlstr = Sqlstr & " and B.grade='" & CmbLetterType.Text & "'   "
'myconn.Execute "drop table RenewalLetter_Vw_sub"
'myconn.Execute " create table RenewalLetter_Vw_sub as " & Sqlstr
...
'    Sqlstr = Sqlstr & " group by sourcecode"
'
'    myconn.Execute "drop table RenewalLetter_Vw"
'    myconn.Execute " create table RenewalLetter_Vw as " & Sqlstr
...
CmbLetterType.Clear
CmbLetterType.AddItem "A", 0
CmbLetterType.AddItem "B", 1
CmbLetterType.ListIndex = 0
End Sub
