<%@ Page Title="SIP Master Reconciliation" Language="C#" MasterPageFile="~/vmSite.Master" AutoEventWireup="true" CodeBehind="sip_master_reconciliation.aspx.cs" Inherits="WM.Masters.sip_master_reconciliation" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:UpdatePanel ID="UpdatePanelFirst" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="date">
                                <asp:TextBox ID="dateFrom" runat="server" CssClass="form-control" oninput="formatDateInput(this)" placeholder="dd/mm/yyyy" MaxLength="10"></asp:TextBox>
                                <%-- DATE FORMAT SCRIPT  --%>
                                <script>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="date">
                                <asp:TextBox ID="dateTo" runat="server" CssClass="form-control " oninput="formatDateInput(this)" placeholder="dd/mm/yyyy" MaxLength="10"></asp:TextBox>
                        ...
                        <div class="col-md-1">
                            ...
                            <div class="form-check-2 d-flex align-items-center gap-3 my-cstm-radio-btn-cntnr-2">
                        ...
                        <%-- BTN: SEARCH, RESET AND EXPORT --%>
                        <div class="col-md-8">
                            <div class="row justify-content-end mt-4 g-3">
                                <div class="col-2">
                    ...
                    <%-- RBD: OP1,OP2 & AR SEARCH ROWCOUNT  --%>
                    <div class="row g-3">
                        <div class="col-md-6">
                ...
                <div class="table-responsive m-4" id="gridContainer1" style="max-height: 250px; overflow-y: auto;">
                    <style>
                        th {
                            position: sticky;
                            top: 0;
    ...
    .highlight-row {
        ...
        cursor: pointer;
                    ...
                    <script type="text/javascript">
                     ...
                     <asp:GridView ID="tableSearchResults"
                           AutopushtBack="true" EnableViewState="true"  
        CssClass="table table-bordered" runat="server"
        OnRowDataBound="tableSearchResults_RowDataBound"
        DataKeyNames="TRAN_CODE"  
        AutoGenerateColumns="false"
        OnRowCommand="tableSearchResults_RowCommand">
                        ...
                        <Columns>
                          ...
                          <asp:TemplateField HeaderText="Address" ItemStyle-Width="80px" HeaderStyle-Width="80px">
                              <ItemTemplate>
                                  <asp:Label ID="lbladressfirst" runat="server" style="width:80px" Text='<%# Eval("ADDRESS") %>' />
                              </ItemTemplate>
                          </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="App No" ItemStyle-CssClass="hide-column" HeaderStyle-CssClass="hide-column">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Total SIP" ItemStyle-CssClass="hide-column" HeaderStyle-CssClass="hide-column">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Flag" ItemStyle-CssClass="hide-column" HeaderStyle-CssClass="hide-column">
                                <ItemTemplate>
                                ...
                                <div class="col-md-4">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="date">
                                                <asp:TextBox ID="dateFromRta" runat="server" CssClass="form-control " oninput="formatDateInput(this)" placeholder="dd/mm/yyyy" MaxLength="10" />
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="date"  >
                                                <asp:TextBox ID="dateToRta" runat="server" CssClass="form-control" oninput="formatDateInput(this)" placeholder="dd/mm/yyyy" MaxLength="10" />
                                ...
                                <div class="col-md-8">
                                    <div class="row g-3 mb-2">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <asp:Button ID="searchBtn" runat="server" Text="Search" CssClass="btn btn-primary" OnClick="btnSearchrta_Click" />
                                                <asp:Button ID="resetBtn" runat="server" Text="Reset" CssClass="btn btn-outline-primary" OnClick="btnReset2_Click" />
                                                <asp:Button ID="exportBtn" runat="server" Text="Export" CssClass="btn btn-outline-primary" OnClick="btnExport_Click" />
                                            </div>
                ...
                <style>
                    ...
                    .loading-overlay {
                        ...
                        width: 100%;
                        height: 100%;
                        background: rgba(255, 223, 128, 0.2); /* Soft warm yellow */
                        display: flex;
